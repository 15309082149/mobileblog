...
import { MessageOutline, AppOutline, KoubeiOutline, TravelOutline, GlobalOutline, StarOutline} from 'antd-mobile-icons'
...
import animation4 from '../../../static/lotties/animation4.json'
import gaming from '../../../static/lotties/gaming.json'
import awards from '../../../static/lotties/awards.json'
...
const Aboutme = () => {
  ...
  const stackarray = [                                    //技术栈数组，存放图片地址与名称
    {  url: require('../../../img/stackimg/vue.png'),
       name: 'Vue',
       color: '#a7f3d0'
    },
    {url: require('../../../img/stackimg/react.png'),
      name: 'React',
      color: '#e2e8f0'
    },
    {url: require('../../../img/stackimg/node.png'),
      name: 'Node.js',
      color: '#c7d2fe'
    },
    {url: require('../../../img/stackimg/css.png'),
      name: 'Css',
      color: '#bae6fd'
    },
    {url: require('../../../img/stackimg/spring.png'),
      name: 'spring',
      color: '#f87171'
    }
  ]
  const stackarray2 = [
    {url: require('../../../img/stackimg/html.png'),
      name: 'Html',
      color: '#fecaca'
    },
    {url: require('../../../img/stackimg/ts.png'),
      name: 'Typescript',
      color: '#f7cb4f'
    },
    {url: require('../../../img/stackimg/js.png'),
      name: 'Javascript',
      color: '#ea2851'
    },
    {url: require('../../../img/stackimg/docker.png'),
      name: 'next',
      color: '#18b8b9'
    },
    {url: require('../../../img/stackimg/unity.png'),
      name: 'unity',
      color: '#e2e8f0'
    }
  ]
          ...
          {items}
            ...
            <div className={s.stack}>
              ...
              {stackarray.map((item,index) => {
                ...
                <div className={s.stackicon} style={{backgroundColor: item.color}}><img src={item.url}></img></div>
            ...
            <div className={s.award}>
              ...
              <div className={s.awards}>
                <div className={s.awardicon}>
                  <Lottie className={s.lottie} animationData={awards}></Lottie>
                </div>
                <span style={{color: '#a855f7',fontWeight:'600'}}>2024年四川省大学生区块链技术应用创新大赛<span style={{color:'#ef4444'}}>一等奖</span></span>
              </div>
            </div>
            <div className={s.award}>
            ...
            <div className={s.award1} style={{position: 'relative'}}>
              <div className={s.topiconarea}><GlobalOutline /><div className={s.iconatext}>About me</div></div>
              <div className={s.interlottie}>
                <Lottie animationData={animation4} className={s.interlottieA}></Lottie>
              </div>
            ...
            <div className={s.musicimg}>
              ...
              <div className={s.map} id="container">
              <MapContainer />
            </div>
            <div className={s.media4}>
              <div className={s.interests}>
              <img src={require("../../../img/cs2.jpeg")} className={s.musicimgs}></img>
            </div>
            <div className={s.inters}>
              <div className={s.topiconarea}><StarOutline /><div className={s.iconatext}>Interests</div></div>
              <div className={s.social}>
                <div className={s.awardicon}>
                  <Lottie className={s.lottie} animationData={gaming} style={{transform:'scale(120%)'}}></Lottie>
                </div>
                <span style={{color: '#34495c',fontWeight:'600'}}>Gaming</span>
              </div>
              <div className={s.social}>
                <div className={s.awardicon}>
                  <Lottie className={s.lottie} animationData={animation2}></Lottie>
                </div>
                <span style={{color: '#f06429',fontWeight:'600'}}>开发</span>
              </div>
              <div className={s.social}>
                <div className={s.awardicon}>
                  <Lottie className={s.lottie} animationData={animation3} style={{transform:'scale(70%)'}}></Lottie>
                </div>
                <span style={{color: '#52c1de',fontWeight:'600'}}>学习技术</span>
              </div>
              </div>
            </div>
            <Endlinks></Endlinks>
